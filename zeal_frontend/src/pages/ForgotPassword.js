                    ...
                    <section className="d-flex align-items-center my-5 mt-lg-6 mb-lg-5">
                        <Container>
                            <p className="text-center">
                                <Card.Link as={Link} to={Routes.SignIn.path} className="text-gray-100">
                                        ...
                                        <Form className="mt-4">
                                            <Form.Group id="username" className="mb-4">
                                                ...
                                                <InputGroup>
                                                    ...
                                                    <Form.Control autoFocus required type="text" placeholder="Enter username" onChange={(event) => this.setCredentials("username", event.target.value)} />
                                                </InputGroup>
                                            </Form.Group>
